...
int main() {
    ...
    image.open("GradientRedMint.ppm"); // This opens or creates a file named: "imageGradient.ppm" You can also create and open the file in one line: std::ofstream image("imageGradient.ppm");
