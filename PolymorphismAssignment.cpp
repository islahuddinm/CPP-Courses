...
public:
    ...
    void work(int a) {
        std::cout << getName() << " is working in " << a << '\n';
    }
...
int main() {
    ...
    employee *employeePtr = new teacher("Sandrina", "Amazon", 32, "English");
    employeePtr->work(4); // if we create object like above we cant assign to 'work function' in derived class because in base class there is no 'work function'.
